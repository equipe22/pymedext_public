...
class SentenceTokenizer(annotators.Annotator):
    ...
    def annotate_function(self, _input):
        ...
        for sent in sentences: 
            ...
            res.append(annotators.Annotation(type=self.key_output,
                                 value=sent,
                                 span=(start, end),
                                 source=self.ID,
                                 source_ID = inp.ID))
...
class DictionaryCatcher(annotators.Annotator):
...
class RegexCatcher(annotators.Annotator):
    """
