#!/usr/bin/env python3
from pymedext import pymedtator
...
if __name__ == "__main__":
    ...
    getRegex = pymedtator.regexFast(key_input = ['raw_text'],
    ...
    sent_tokenizer = pymedtator.SentenceTokenizer( key_input = ['preprocessed_text'],
                                       key_output = "sentence",
                                       ID = "SentenceTokenizer.v1",
                                       language= 'french')

    romedi_catcher = pymedtator.RomediCatcher( key_input = ['sentence'],
                                       key_output = "drug",
    ...
    dose_catcher = pymedtator.DoseCatcher(key_input = ['drug','sentence'],
                                       key_output = "dose",
                                      remove_accents = True,
                                       ignore_case=True,
                                       ID = "DoseCatcher.v1")
